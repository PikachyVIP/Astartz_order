...
public class PlacedFeatureInit {
    public static final RegistryKey<PlacedFeature> OVERWORLD_EXAMPLE_ORE_KEY = registerKey("overworld_ifirium_ore");
    ...
    private static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Story.id(name));
    }
