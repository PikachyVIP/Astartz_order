...
public class SplavScreen extends HandledScreen<SplavScreenHandler> {

    private static final Identifier GUI_TEXTURE =
            Identifier.of(Story.MOD_ID, "textures/gui/gui2.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(Story.MOD_ID, "textures/gui/arrow_progress.png");

    public SplavScreen(SplavScreenHandler handler, PlayerInventory inventory, Text title) {
